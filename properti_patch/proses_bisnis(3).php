...
if (mysqli_num_rows($q_cek) == 0) {
    ...
    if ($unclaimed_yield > 0) { 
        ...
        $html_rincian .= "
        <tr>
            <td>" . ($tipe_simulasi == 'properti' ? 'Laba Properti Masuk' : 'Laba Bisnis Masuk') . "</td>
    ...
    if ($keputusan == 'sell') {
        ...
        // KHUSUS PROPERTI:
        // Pada periode 3, tanpa asuransi nilai jual menjadi 0.
        if ($tipe_simulasi == 'properti' && $active_period == 3) {
        ...
        $pesan_sukses = ($tipe_simulasi == 'properti')
            ? "Laba Properti Berhasil Diklaim"
            : "Laba Bisnis Berhasil Diklaim";
    }
    ...
    Swal.fire({
        ...
        html: `
            <div style="text-align:left">
                <p>Keputusan '.($tipe_simulasi == 'properti' ? 'properti' : 'bisnis').' untuk aset <b>'.$nama_aset.'</b> berhasil diproses.</p>
                <hr>
